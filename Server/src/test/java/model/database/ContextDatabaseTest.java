...
public class ContextDatabaseTest {
    ...
    public void addWorldTest() {
        ...
        World test = new World("test_world", ContextMap.PUBLIC_ROOM_MAP);
        ...
        try {
            ...
            Assert.assertEquals(ContextMap.PUBLIC_ROOM_MAP.name(), real_map_name);
    ...
    public void getWorldsTest() {
        World test1 = new World("test1_world", ContextMap.PUBLIC_ROOM_MAP);
        World test2 = new World("test2_world", ContextMap.PUBLIC_ROOM_MAP);
