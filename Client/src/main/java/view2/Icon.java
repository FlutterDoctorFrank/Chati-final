...
public class Icon {
    ...
    public static final Drawable NOTIFICATION_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/notificationIcon.png")));
    ...
    public static final Drawable DISABLED_REMOVE_FRIEND_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_removeFriend_grey.png")));
    public static final Drawable IGNORE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_ignore_color.png")));
    public static final Drawable DISABLED_IGNORE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_ignore_grey.png")));
    public static final Drawable UNIGNORE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_unignore_color.png")));
    public static final Drawable DISABLED_UNIGNORE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_unignore_grey.png")));
    public static final Drawable ROOM_INVITE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_invite_color.png")));
    public static final Drawable DISABLED_ROOM_INVITE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_invite_grey.png")));
    public static final Drawable ROOM_KICK_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_kick_color.png")));
    public static final Drawable DISABLED_ROOM_KICK_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_kick_grey.png")));
    public static final Drawable TELEPORT_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_teleport_color.png")));
    public static final Drawable DISABLED_TELEPORT_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_teleport_grey.png")));
    public static final Drawable REPORT_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_report_color.png")));
    public static final Drawable DISABLED_REPORT_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_report_grey.png")));
    public static final Drawable MUTE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_mute_color.png")));
    public static final Drawable DISABLED_MUTE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_mute_grey.png")));
    public static final Drawable UNMUTE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_unmute_color.png")));
    public static final Drawable DISABLED_UNMUTE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_unmute_grey.png")));
    public static final Drawable BAN_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_ban_color.png")));
    public static final Drawable DISABLED_BAN_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_ban_grey.png")));
    public static final Drawable UNBAN_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_unban_color.png")));
    public static final Drawable DISABLED_UNBAN_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_unban_grey.png")));
    ...
    public static final Drawable DECLINE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_decline_color.png")));
    public static final Drawable DISABLED_DECLINE_ICON = new TextureRegionDrawable(new TextureRegion(new com.badlogic.gdx.graphics.Texture("icons/new_decline_grey.png")));
